...
resource "aws_ecs_task_definition" "my-task" {
  ...
  container_definitions = jsonencode([
    {
      name  = "my-app"
      image = "941876206785.dkr.ecr.us-east-1.amazonaws.com/my-repo.dkr.ecr.us-east-1.amazonaws.com/my-repo/my-express-app:latest"
      portMappings = [
        {
          containerPort = 3000
          hostPort      = 3000
...
resource "aws_ecs_service" "my-service" {
  ...
  load_balancer {
    target_group_arn = "arn:aws:elasticloadbalancing:us-east-1:941876206785.dkr.ecr.us-east-1.amazonaws.com/my-repo:targetgroup/finaltg/99029c91dc813bac"
